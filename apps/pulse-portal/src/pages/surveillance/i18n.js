...
export const TXT = {
  ar: {
    title: "منصة PULSE للمراقبة الوبائية",
    subtitle:
      "مبادرة مجتمعية/وطنية تجريبية لاستخدام إشارات المختبرات لدعم الإنذار المبكر وصناعة القرار الصحي على مستوى السكان.",
    note:
      "نصيحة: استخدام أكثر من طريقة يعطي قرارًا أقوى. الحساسية الأعلى قد تلتقط تغيرات أسرع لكنها قد تزيد الإنذارات الكاذبة.",
    initiativeTitle: "عن المبادرة",
    initiativeBody:
      "تم تطوير هذا النموذج الأولي كمبادرة ابتكار مجتمعي بهدف تعزيز ثقافة البيانات والصحة العامة، ودعم الجهود الوطنية في الرصد المبكر عبر تحليل نتائج مختبر روتينية بشكل مجهول الهوية وعلى مستوى السكان.",
    unDisclaimerTitle: "تنبيه مهم",
    unDisclaimerBody:
      "هذا نظام دعم قرار سكاني (Population-level Decision Support) وليس أداة تشخيص فردي. النتائج تُفسَّر بالتنسيق مع الجهات الصحية المختصة وبحسب سياق البيانات وجودتها.",
    footerLine1: "مبادرة تطوير مجتمعية — مدرسة ذكور نزال الإعدادية الأولى",
    footerLine2: "بدعم بيئة التعلم والابتكار في الأونروا — UNRWA",
    footerLine3: "© PULSE (Prototype) — للاستخدام البحثي/التجريبي",
    scope: "نطاق التحليل",
  ...
  en: {
    title: "PULSE Surveillance Platform",
    subtitle:
      "A community/national pilot using routine laboratory signals to support early warning and population-level public health decision-making.",
    note:
    ...
    initiativeBody:
      "This prototype was developed as a community innovation effort to promote data-informed public health, using de-identified routine lab results and population-level analytics.",
    unDisclaimerTitle: "Important notice",
    unDisclaimerBody:
    ...
    footerLine1: "Community Innovation Initiative — Nazzal Prep Boys School 1",
    footerLine2: "Supported within UNRWA learning & innovation environment — UNRWA",
